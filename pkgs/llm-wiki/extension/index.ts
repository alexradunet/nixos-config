...
const LintModeEnum = StringEnum(["links", "orphans", "frontmatter", "duplicates", "coverage", "staleness", "stale-reviews", "empty-summary", "duplicate-id", "unresolved-ids", "thin-content", "crossref-gaps", "all"] as const);
...
function buildWikiContextPrompt(): string {
	...
	return [
		...
		"- wiki_lint: checks links, orphans, frontmatter, duplicates, coverage, staleness, stale reviews, empty summaries, duplicate ids, unresolved relation ids, thin content, and cross-reference gaps.",
...
export default function (pi: ExtensionAPI) {
	...
	const tools: RegisteredExtensionTool[] = [
		...
		},
		{
			name: "wiki_lint",
			label: "Wiki Lint",
			description: "Run structural wiki checks for broken links, frontmatter, duplicates, coverage, staleness, stale reviews, empty summaries, duplicate ids, unresolved relation ids, thin content, and cross-reference gaps.",
