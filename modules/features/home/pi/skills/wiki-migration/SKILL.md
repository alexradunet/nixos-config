...
description: >
  ...
  plain-Markdown wiki at ~/Wiki. Use when asked to migrate notes, convert
...
Migrate notes from `~/Wiki_backup/pages/` → `~/Wiki/pages/` one batch at a time.
...
qmd collection add wiki /home/alex/Wiki
...
```bash
qmd context add wiki-schema /home/alex/Wiki/WIKI_SCHEMA.md
qmd context add wiki-rules /home/alex/Wiki/WIKI_RULES.md
```
...
cat /home/alex/Wiki/WIKI_SCHEMA.md
```
...
After each batch append entries to `/home/alex/Wiki/meta/registry.json`:
...
grep -rn '\[\[[^]]*\]\]' /home/alex/Wiki/pages/ || echo 'no wikilinks'
