...
| `task` | `pages/planner/tasks/` | `schemas/task.md` |
| `event` | `pages/planner/calendar/` | `schemas/event.md` |
| `reminder` | `pages/planner/reminders/` | `schemas/reminder.md` |
